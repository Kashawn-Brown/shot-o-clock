...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      round_player_outcomes: {
        Row: {
          ...
          round_id: string;
          round_number: number;
          status_after_round: Database['public']['Enums']['player_status'] | null;
          status_before_round: Database['public']['Enums']['player_status'] | null;
          updated_at: string;
        };
        Insert: {
          created_at?: string;
    ...
    Enums: {
      ...
      notification_permission_status: 'granted' | 'denied' | 'provisional' | 'unknown';
      out_reason:
        | 'missed_round'
        | 'self_opted_out'
        | 'host_marked_out'
      ...
      party_phase:
        ...
        | 'round_complete'
        | 'ended';
      party_status: 'lobby' | 'active' | 'paused' | 'ended' | 'expired' | 'cancelled';
      party_visibility: 'invite_code_only' | 'private';
      player_action: 'none' | 'done' | 'self_out' | 'missed';
      player_duty: 'normal_player' | 'assigned_monitor' | 'referee_pool' | 'spectator';
      player_permission_role: 'host' | 'admin' | 'player';
      player_status: 'active' | 'out' | 'removed';
      referee_mode: 'none' | 'assigned_monitor' | 'referee_pool';
      referee_verdict: 'pending' | 'confirmed' | 'missed' | 'questionable' | 'not_required';
      removed_player_reason: 'host_kicked' | 'self_left_lobby' | 'inactive' | 'other';
      round_status:
        | 'scheduled'
        | 'countdown'
        | 'shot_window'
